...
| Guardar variante (UI-03/UI-04) | Publicado en PR #28; Vercel confirmado 2026-09-21 | Bajo | Precarga un borrador independiente; confirma mediante `create_print_project`, sin escrituras sobre el proyecto fuente, inventario o históricos. No copia archivos implícitamente. Guardado bloqueado contra doble envío inmediato. Sin migración nueva; no se ejecutó una nueva escritura autenticada en producción. UI-01A solo cambia presentación; conserva estos contratos y todos los formularios. |
