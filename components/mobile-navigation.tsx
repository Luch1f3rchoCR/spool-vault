...
import { House, LogIn, PackageSearch, QrCode, UserRound, Weight } from "lucide-react";
...
export function MobileNavigation({ isSignedIn, onAccount, onScan, onWeigh }: MobileNavigationProps) {
  return (
    <nav className="mobile-nav" aria-label="Navegación principal">
      ...
      <button type="button" onClick={onScan}><QrCode size={20} aria-hidden="true" /><span>Escanear</span></button>
